  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-2xl font-display">Publica tu espacio en SpacePal</DialogTitle>
          <DialogDescription className="pt-4 text-base">
            Estás a punto de comenzar el proceso de publicación de tu espacio. Completarás un formulario con:
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="py-4">
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="bg-brand-purple/10 rounded-full p-1">
